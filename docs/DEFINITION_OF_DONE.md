...
- A multi-document proposal was committed and pushed to one short-lived branch
  in the authoritative repository before independent review.
...
- The Chief Architect reviews the actual artifacts and records a formal
  decision.
- The independent reviewer and Chief Architect decisions resolve the exact
  proposal head; a changed head receives the applicable re-review.
