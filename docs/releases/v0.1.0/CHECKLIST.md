...
| CI dependency warning is owned | Candidate | Pass | The release-time warning was non-blocking and assigned. Post-release pull request #14 updated the pin to official verified `v7.0.1`; its pull-request and merged-main checks passed without annotations, and branch protection remained unchanged. |
