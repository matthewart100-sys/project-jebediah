...
| GitHub repository | Engineering-memory boundary | Active engineering memory | Own reviewed project documentation, decisions, history, and safe source artifacts | Maintainer accountable | Sprint 005 implementation review and merge decision |
...
| Jebediah Memory Service | Semantic memory component | Implemented | Govern memory candidates through one canonical package, persist one acknowledged Qdrant point, and retrieve semantic-only context | Maintainer accountable | Sprint 005 implementation review, isolated integration, and deployment decision |
