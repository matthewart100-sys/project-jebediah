...
| Collector Engine | Controlled ingestion component | Implemented | Validate and normalize bounded text records, derive identity, preserve provenance, and coordinate storage; ADR 0013 and the accepted Phase 2 activation bound a disconnected synthetic document-admission repository candidate with no runtime or real-information authority | Maintainer accountable | Exact-head implementation review and Chief Architect merge disposition for the synthetic candidate |
